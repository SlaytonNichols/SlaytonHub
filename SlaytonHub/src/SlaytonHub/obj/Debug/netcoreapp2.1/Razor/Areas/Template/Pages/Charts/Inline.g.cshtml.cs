#pragma checksum "/home/slayton/Projects/SlaytonHub/SlaytonHub/src/SlaytonHub/Areas/Template/Pages/Charts/Inline.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "c5f0f8d1cfb252d676b519e57c326e9b413e65e4"
// <auto-generated/>
...
namespace SlaytonHub.Areas.Template.Pages.Charts
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"c5f0f8d1cfb252d676b519e57c326e9b413e65e4", @"/Areas/Template/Pages/Charts/Inline.cshtml")]
...
#line hidden
            ...
            DefineSection("Scripts", async() => {
                BeginContext(102, 7459, true);
                WriteLiteral(@"
    <!-- jQuery Knob Chart -->
    <script src=""https://d1m0vzlwib3qni.cloudfront.net/lib/jQuery-Knob/jquery.knob.min.js""></script>
    <!-- Sparkline -->
  ...
  function drawDocSparklines() {
    ...
    $('#linecustom').sparkline('html',
        {
          height: '1.5em', width: '8em', lineCol");
                WriteLiteral(@"or: '#f00', fillColor: '#ffa',
    ...
    $('#compositeline').sparkline([4, 1, 5, 7, 9, 9, 8, 7, 6, 6, 4, 7, 8, 4, 3, 2, 2, 5, 6, 7],
        {composite: true, fillColor: false, lineColor: 'red', cha");
                WriteLiteral(@"ngeRangeMin: 0, chartRangeMax: 10});
   ...
   ** (roughly) how far the mouse");
                WriteLiteral(@" has moved
    ...
    var mdraw = function () {
      ...
      if (lastmousetime && lastmousetime != timenow) {
        ...
        if (mpoints.length > mpoints_max)
          mpoints.splice(0, 1);
        mousetravel = 0;
        $('#mousespeed').sparkline(mpoin");
                WriteLiteral(@"ts, {width: mpoints.length * 2, tooltipSuffix: ' pixels per second'});
      }
