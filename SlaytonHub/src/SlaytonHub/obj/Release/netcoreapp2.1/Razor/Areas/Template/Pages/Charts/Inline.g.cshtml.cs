#pragma checksum "/home/slayton/Projects/SlaytonHub/SlaytonHub/src/SlaytonHub/Areas/Template/Pages/Charts/Inline.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "97126ff23b0b743e1f07a9bebc6b96ba06585d6e"
// <auto-generated/>
...
namespace SlaytonHub.Areas.Template.Pages.Charts
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"97126ff23b0b743e1f07a9bebc6b96ba06585d6e", @"/Areas/Template/Pages/Charts/Inline.cshtml")]
...
#line hidden
  ...
  function drawDocSparklines() {
    ...
    $('#linecustom').sparkline('html',
        {
          height: '1.5em', width");
                WriteLiteral(@": '8em', lineColor: '#f00', fillColor: '#ffa',
    ...
    $('#compositeline').sparkline([4, 1, 5, 7, 9, 9, 8, 7, 6, 6, 4, 7, 8, 4, 3, 2, 2, 5, 6, 7],
        {composite: true, fillColor: false, lineC");
                WriteLiteral(@"olor: 'red', changeRangeMin: 0, chartRangeMax: 10});
    ...
    $('.boxfield");
                WriteLiteral(@"order').sparkline('html', {
      type: 'box',
   ...
   ** (roughly) h");
                WriteLiteral(@"ow far the mouse has moved
  ...
  function drawMouseSpeedDemo() {
    ...
    var mdraw = function () {
      ...
      if (lastmousetime && lastmousetime != timenow) {
        ...
        mousetravel = 0;
        $('#mousespeed')");
                WriteLiteral(@".sparkline(mpoints, {width: mpoints.length * 2, tooltipSuffix: ' pixels per second'});
      }
